        ...
        <div className="max-w-7xl mx-auto flex items-start justify-between">
          ...
          <div className='flex flex-col text-zinc-500 text-sm/6'>
            ...
            <div className='flex flex-row gap-2 text-white'>
                <a className='rounded-full p-3 bg-yellow-400'><Facebook /></a>
                <a className='rounded-full p-3 bg-yellow-400'><Instagram /></a>
                <a className='rounded-full p-3 bg-yellow-400'><Twitter /></a>
                <a className='rounded-full p-3 bg-yellow-400'><Youtube /></a>
            </div>
          </div>
        </div>
      </nav>      
